  ...
  render() {
    return (
      <div className={styles.App}>
        <Header />
        <header className="py-5 bg-image-full" style={{backgroundImage: 'url("https://picsum.photos/1900/1080?grayscale")'}}>
          <img className="img-fluid d-block mx-auto" src="https://www.kewrunner.com/wp-content/uploads/2021/05/001-Favorites-02-Black-01.png" alt="..." />
          </header>
        {
          this.renderPublish()
        }
        <div id="flatbackarea" className="" style={{backgroundImage: 'url("https://picsum.photos/1900/1080?blur=4")', width: '100%'}}>
